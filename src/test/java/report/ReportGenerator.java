...
public class ReportGenerator {
    ...
    public StringBuilder returnHTMLReport() {
        ...
        html.append("}</script>");
        html.append("<link rel='stylesheet' href='https://www.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css'/>");
        html.append("<script src='https://code.jquery.com/jquery-3.3.1.slim.min.js'></script>");
        html.append("<script src='https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js'></script");
        html.append("<script src='https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js'></script>");
